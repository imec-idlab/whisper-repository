...
QString EventLog::getPacketTypeString(rpl::Event * event) const {
    ...
    case PT_TCP:
        return "TCP";
    case PT_6P_ADD:
	    return "6P ADD Request";
	case PT_6P_DELETE:
		return "6P DELETE Request";
	case PT_6P_RELOCATE:
		return "6P RELOCATE Request";
	case PT_6P_COUNT:
		return "6P COUNT Request";
	case PT_6P_LIST:
		return "6P LIST Request";
	case PT_6P_CLEAR:
		return "6P CLEAR Request";
	case PT_6P_SIGNAL:
		return "6P SIGNAL Request";
	case PT_6P_RESPONSE:
		return "6P Response";
	case PT_6P_CONFIRMATION:
		return "6P Confirmation";		
