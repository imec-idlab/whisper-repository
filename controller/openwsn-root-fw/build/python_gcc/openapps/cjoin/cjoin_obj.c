...
This was done on 2018-03-08 18:27:44.823928.
*/
/**
...
owerror_t cjoin_receive(OpenMote* self, OpenQueueEntry_t* msg,
 ...
 IEEE802154_security_setBeaconKey(self, join_response.keyset.key[0].kid[0], join_response.keyset.key[0].k);
 IEEE802154_security_setDataKey(self, join_response.keyset.key[0].kid[0], join_response.keyset.key[0].k);
...
owerror_t cjoin_sendJoinRequest(OpenMote* self, open_addr_t* joinProxy) {
 ...
 openqueue_freePacketBuffer(self, pkt);
   ...
   prefix = idmanager_getMyID(self, ADDR_PREFIX); // at this point, this is link-local prefix
