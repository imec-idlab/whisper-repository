...
This was done on 2018-03-08 18:25:35.858825.
*/
/**
...
enum {
   ...
   COMPONENT_WHISPER				   = 0x2d,
   COMPONENT_WHISPERSENDER			   = 0x2e,
};
...
typedef struct {
   ...
   bool          isSixtopFake;                                  // isSixtopFake
   bool          isDioFake;                                  // isSixtopFake
} OpenQueueEntry_t;
