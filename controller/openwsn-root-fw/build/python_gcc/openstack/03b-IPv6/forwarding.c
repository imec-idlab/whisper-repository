...
owerror_t forwarding_send(OpenQueueEntry_t* msg) {
    ...
    if (msg->creator == COMPONENT_ICMPv6RPL){
		if( (msg->isDioFake==TRUE) && (idmanager_getIsDAGroot()==TRUE) ){
...
//			   };
			...
			//whisper_target128[15]=whisper_getTargetParentOld();
...
void forwarding_getNextHopWhisper(open_addr_t* destination128b, open_addr_t* addressToWrite64b) {
...
//	   forwarding_getNextHopWhisper(&(msg->l3_destinationAdd),&(msg->l2_nextORpreviousHop));
//
//   }else{
//	   // retrieve the next hop from the routing table
//	   forwarding_getNextHop(&(msg->l3_destinationAdd),&(msg->l2_nextORpreviousHop));
...
//			   };
			...
			uint8_t whisperroot_nexthop_to_target[] = {
					   0xbb, 0xbb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
					   0x00, 0x12, 0x4b, 0x00, 0x06, 0x13, 0x0f, 0x61
				};
			...
			//printf("I am whisperroot node %d, mac addresses done, source add l3: %d ... %d \n", idmanager_getMyID(ADDR_64B)->addr_64b[7],msg->l3_sourceAdd.addr_128b[0],msg->l3_sourceAdd.addr_128b[15]);
		   ...
		   forwarding_getNextHop(&(msg->l3_destinationAdd),&(msg->l2_nextORpreviousHop));
		   //leds_debug_toggle();
		   //printf("I am NODE %d, next hop is %d\n", idmanager_getMyID(ADDR_64B)->addr_64b[7],msg->l2_nextORpreviousHop.addr_64b[7]);
