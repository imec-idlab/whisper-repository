...
uint8_t neighbors_getSequenceNumber(open_addr_t* address){
    ...
    //printf("I am node %d, my current sequence number is %d with neighbor %d\n", idmanager_getMyID(ADDR_64B)->addr_64b[7],neighbors_vars.neighbors[i].sequenceNumber,address->addr_64b[7]);
...
//    if (idmanager_getMyID(ADDR_64B)->addr_64b[7]==4){
