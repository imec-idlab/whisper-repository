...
This was done on 2018-03-08 18:26:03.616620.
*/
...
//						if (NeighborAddress.addr_64b[7] == whisper_getFakeSource(self)){
...
//
// packetfunctions_writeAddress(self, msg,&NeighborAddress,OW_LITTLE_ENDIAN);
//
//		   }else{
...
//
// packetfunctions_writeAddress(self, msg,&temp_src_mac64b,OW_LITTLE_ENDIAN);
//		   }else{
// packetfunctions_writeAddress(self, msg, idmanager_getMyID(self, ADDR_64B),OW_LITTLE_ENDIAN);
//		   }
//		   break;
...
//		   if  ( (frameType == IEEE154_TYPE_ACK) && ( idmanager_getMyID(self, ADDR_64B)->addr_64b[7] == 0x07) && ( whisper_getState(self)==6) ){
//
//				open_addr_t      NeighborAddress;
//				for (i=0;i<MAXNUMNEIGHBORS;i++) {
//					if ( neighbors_getNeighborEui64(self, &NeighborAddress, ADDR_64B, i)) { // this neighbor entry is in use
