...
This was done on 2018-03-08 19:45:01.046170.
*/
...
owerror_t iphc_sendFromForwarding(OpenMote* self, 
 ...
 openserial_printError(self, COMPONENT_IPHC,ERR_HOP_LIMIT_REACHED,
    ...
    //    if ((msg->isDioFake==TRUE) && ( idmanager_getIsDAGroot(self)==TRUE) ){
    //
    //    	printf("I am whisperroot node %d, poipoi. dest L3 address %d \n", idmanager_getMyID(self, ADDR_64B)->addr_64b[7],&(msg->l3_sourceAdd.addr_128b[15]));
...
//			}
    		...
    		//printf("I am whisperroot node %d,IPCH from %d to %d \n", idmanager_getMyID(self, ADDR_64B)->addr_64b[7],temp_src_mac64b.addr_64b[7],temp_dest_mac64b.addr_64b[7]);
