...
owerror_t iphc_sendFromForwarding(
    ...
    msg->owner = COMPONENT_IPHC;
	   ...
	   //printf("I am WISHPER node %d, sending from forwarding \n",idmanager_getMyID(ADDR_64B)->addr_64b[7]);



		 if (msg->isDioFake==FALSE){

			// error checking
			if (idmanager_getIsDAGroot()==TRUE &&
				packetfunctions_isAllRoutersMulticast(&(msg->l3_destinationAdd))==FALSE) {
				//printf("I am whisperroot node %d, all routers mutlicast \n", idmanager_getMyID(ADDR_64B)->addr_64b[7]);
		...
		//printf("I am whisperroot node %d, checking hops \n", idmanager_getMyID(ADDR_64B)->addr_64b[7]);
    ...
    //    if ((msg->isDioFake==TRUE) && (idmanager_getIsDAGroot()==TRUE) ){
    //
    //    	printf("I am whisperroot node %d, poipoi. dest L3 address %d \n", idmanager_getMyID(ADDR_64B)->addr_64b[7],&(msg->l3_sourceAdd.addr_128b[15]));
    //    	printf("I am whisperroot node %d, poipoi IPCH. src L3 address %d \n", idmanager_getMyID(ADDR_64B)->addr_64b[7],&(msg->l3_sourceAdd.addr_128b[15]));
    //    }
        ...
        if ((msg->isDioFake==TRUE) && (idmanager_getIsDAGroot()==TRUE) ){
    		...
    		temp_dest_mac64b.addr_64b[6]=0x0f;
			temp_src_mac64b.addr_64b[6]=0x0f;

			if (whisper_getTargetParentOld()==0x55){

	    		temp_dest_mac64b.addr_64b[7]=0x61;	//next hop address
	    		temp_src_mac64b.addr_64b[7]=0x6b;
			}else{
	    		temp_dest_mac64b.addr_64b[7]=0x2b;	//next hop address
	    		temp_src_mac64b.addr_64b[7]=0x6b;
			}

//    			    		temp_dest_mac64b.addr_64b[7]=2;	//next hop address
//    			    		temp_src_mac64b.addr_64b[7]=1;

    		//printf("I am whisperroot node %d,IPCH from %d to %d \n", idmanager_getMyID(ADDR_64B)->addr_64b[7],temp_src_mac64b.addr_64b[7],temp_dest_mac64b.addr_64b[7]);
